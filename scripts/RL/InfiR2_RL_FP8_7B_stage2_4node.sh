...
LOAD_DIR=/path/to/load_dir_stg2_RL16k/
SAVE_DIR=/path/to/save_dir_stg2_RL16k/
DATA_DIR=/path/to/data/dapo-math-17k.jsonl
HF_CHECKPOINT=/path/to/models_FP8_config_hf/InfiR2_SFT_FP8_stg2_hf__e8m0/
REF_LOAD=/path/to/models_torch_dist/InfiR2-RL-FP8-stg1/
# ==============================================================
...
WANDB_ARGS=(
   ...
   --wandb-group InfiR2-RL-fp8-stg2-16k
   --wandb-mode offline
   --wandb-dir ${LOG_DIR}
)
