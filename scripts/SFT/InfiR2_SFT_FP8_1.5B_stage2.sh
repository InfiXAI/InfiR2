...
LOAD_DIR=/path/to/load_dir_InfiR2_SFT_FP8_1.5B_stg2/
SAVE_DIR=/path/to/save_dir_InfiR2_SFT_FP8_1.5B_stg2/
DATA_DIR=/path/to/stage2_data
HF_CHECKPOINT=/path/to/base_models_hf/qwen2.5-1.5B-Instruct/
REF_LOAD=/path/to/base_models_/InfiR2_SFT_FP8_1.5B_stg1_torch_dist/
# ==============================================================
...
WANDB_ARGS=(
   ...
   --wandb-group InfiR2-sft-fp8-1.5B-stg2
   --wandb-dir ${LOG_DIR}/InfiR2-sft-fp8-1.5B-stg2__wandb
   # --wandb-key ${WANDB_KEY}
)
...
TENSORBOARD_ARGS=(
   ...
   --profile-step-end 18
   --tensorboard-dir ${LOG_DIR}/tensorboard/InfiR2-sft-fp8-1.5B-stg2
