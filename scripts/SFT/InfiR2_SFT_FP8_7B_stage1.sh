...
LOAD_DIR=/path/to/load_dir_InfiR2_SFT_FP8_7B_stg1/
...
WANDB_ARGS=(
   ...
   --wandb-group InfiR2-sft-fp8-7B-stg1
   --wandb-dir ${LOG_DIR}/InfiR2-sft-fp8-7B-stg1__wandb
   # --wandb-key ${WANDB_KEY}
)
...
TENSORBOARD_ARGS=(
   ...
   --profile-step-end 18
   --tensorboard-dir ${LOG_DIR}/tensorboard/InfiR2-sft-fp8-7B-stg1
